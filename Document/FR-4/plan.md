...
- **基本指令集**：`/watch`, `/unwatch`, `/list`, `/status`, `/progress`, `/help`, `exit`/`quit`/`q`
...
├── tools/
│   ├── __init__.py            # MOD: 注册 QueryProgressTool / HelpTool
...
| Phase 1 — Parser & Intent 测试 | ⬜ | T410~T412 全部完成且测试绿 |
| Phase 2 — Tool & Shell 核心 | ⬜ | T420~T424 全部完成 |
| Phase 3 — CLI 改造与集成 | ⬜ | T430~T432 全部完成 |
| Phase 4 — 端到端与 Smoke | ⬜ | T440~T441 全部完成 |
